...
import { AgentCapability, GraphState, NodeType, Artifact } from '../types';
        ...
        'check_caption': {
          ...
          config: {
            check: (state: GraphState) => {
              ...
              return state.generateCaption === true ? 'generate_caption' : 'end';
            }
          }
        },
        ...
        'store_caption': {
          ...
          config: {
            ...
            execute: async (state: GraphState) => {
              ...
              const imageArtifact = state.artifacts?.find(a => a.type === 'image');
