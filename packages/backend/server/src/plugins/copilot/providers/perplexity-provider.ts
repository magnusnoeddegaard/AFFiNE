...
export class PerplexityProvider extends BaseLLMProvider {
  ...
  async complete(
    ...
    console.log(
      `[PerplexityProvider] Generating completion with model: ${config.model}`
    );
    console.log(
      `[PerplexityProvider] Messages:`,
  ...
  async *completeStream(
    ...
    console.log(
      `[PerplexityProvider] Streaming completion with model: ${config.model}`
    );
    console.log(
      `[PerplexityProvider] Messages:`,
      JSON.stringify(formattedMessages, null, 2)
